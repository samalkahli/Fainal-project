              ...
              <div class="card">
                ...
                {?>
                    ...
                    <td><?php echo $i; $i++; ?></td>
                      ...
                      <td>
                      <a href="edit-lecturer.php?id=<?php echo $row['Su_ID'];?>">
                      <button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> </a>                                        
                      <a href="manage-lecturer.php?id=<?php echo $row['Su_ID']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">
