...
{?>
    ...
    <select class="form-control" name="subtopic" id="subT" >
    <option value="0">select the subTopic :</option>
    <?php
    while ($r = mysqli_fetch_assoc($q)) { ?>        
    <option id="subbt"  value='<?php echo $r['Ch_ID']?>'><?php echo $r['Ch_SupTopic']?></option>
    <?php }?>
    </select>
...
<?php } 
else{ echo "you don't have any  and subtopics"; }?>
