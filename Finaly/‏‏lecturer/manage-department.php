...
if (strlen($_SESSION['id']==0))
  ...
  header('location:../outSession.php');
        ...
        if(isset($_GET['del']))
        {
        mysqli_query($conn,"delete from department where D_ID = '".$_GET['id']."'");
              ...
              <div class="card">
                ...
                {?>
                    ...
                    <td><?php echo $i; $i++; ?></td>
                      ...
                      <a href="manage-department.php?id=<?php echo $row['D_ID']; ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">
                  ...
                  else echo "You doesn't have any department";?>
                            </tbody>
                    </table>
                  </div>
                </div>
